...
import 'package:seekfighter/Screens/forgot_password/forgot_password_screen.dart';
          ...
          DefaultButton(
            ...
            press: () async{
              if (_formKey.currentState.validate()) {
                ...
                MyAppUser result= await _Auth.signInWithEmailAndPassword(email, password);
                if(result ==null){
                  addError(error: 'Could not sign in with those credentials');
                }else Navigator.pushNamed(context,SplashScreen.routeName);
              }
            },
          ),
        ],
